function data = halfkernel(N, minx, r1, r2, r3,  noise, ratio)
if nargin < 1
    N = 1000;
end
if mod(N,2) ~= 0
...
phi3 = rand(N/2,1) * pi;
middle = [minx + r3 * sin(phi3) - .5 * noise  + noise * rand(N/2,1) r3 * ratio * cos(phi3) - .5 * noise + noise * rand(N/2,1) 2*ones(N/2,1)];
